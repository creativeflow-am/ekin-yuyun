      ...
      <div className="w-full">
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-4 items-end mb-6 pb-6 border-b border-slate-200/80">
          <div className="w-full md:w-1/4">
            ...
            <select value={filterBulan} onChange={(e) => setFilterBulan(e.target.value)} className="input-field w-full p-2.5 sm:p-3 bg-slate-50 lg:bg-white border border-slate-200 rounded-md focus:ring-2 focus:ring-[#FDB200] outline-none text-slate-700 text-sm cursor-pointer transition-all hover:border-[#FDB200]/50">
          ...
          <div className="w-full md:w-auto ml-auto mt-2 md:mt-0 flex flex-row gap-2">
            ...
            <button onClick={() => generatePdfWfa(filteredTasks, filterBulan)} className="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-2.5 px-5 rounded-md transition-all shadow-md flex justify-center items-center gap-2 text-sm sm:text-base whitespace-nowrap">
                      ...
                      <div key={item.id || `${dateIndex}-${skpIndex}-${itemIndex}`} className="bg-white border border-slate-200 rounded-xl p-3.5 mb-2.5 shadow-sm active:bg-slate-50">
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2">
                          ...
                          <div className="flex gap-1.5 flex-shrink-0">
                            <button onClick={() => setEditingTask(item)} className="p-1.5 rounded-lg border border-[#158684]/20 bg-[#158684]/10 hover:bg-[#158684]/20 transition-colors">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-[#158684]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                              </svg>
                            </button>
